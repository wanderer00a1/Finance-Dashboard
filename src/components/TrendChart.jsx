      ...
      {data.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={240}>
          <ComposedChart data={data} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
            ...
            <Bar dataKey="income"   name="Income"   fill="#16a34a" fillOpacity={0.8} radius={[4,4,0,0]} />
            <Bar dataKey="expenses" name="Expenses" fill="#dc2626" fillOpacity={0.8} radius={[4,4,0,0]} />
          </ComposedChart>
        </ResponsiveContainer>
      )}
    </div>
